...
class StoicAlgorithm(MultiClassAlgorithm):
    def __init__(self):
        ...
        self.model.sigma1 = torch.nn.Parameter(torch.ones(1))
        self.model.sigma2 = torch.nn.Parameter(torch.ones(1))
#         s1 = model.sigma1
#         s2 = model.sigma2
        self.model = self.model.to(device)
        self.model.load_state_dict(torch.load('./algorithm/best.pth', map_location=torch.device(device)))
